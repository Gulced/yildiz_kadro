...
class Day4RoomAllocation {
  const Day4RoomAllocation(
      {required this.roomByContestantId, required this.fitByContestantId});
...
String day4ChoiceLabel(Day4Room room, Day4MentorChoice choice) =>
    switch ((room, choice)) {
      (Day4Room.vocal, Day4MentorChoice.optionA) => 'TEMİZ SÖYLEYİN',
      (Day4Room.vocal, Day4MentorChoice.optionB) => 'KENDİNİZİ DUYURUN',
      (Day4Room.dance, Day4MentorChoice.optionA) => 'SENKRONDA KALIN',
      (Day4Room.dance, Day4MentorChoice.optionB) =>
        'KENDİNİZDEN BİR ŞEY EKLEYİN',
      (Day4Room.star, Day4MentorChoice.optionA) => 'TEK BİR İMZA ANI',
      (Day4Room.star, Day4MentorChoice.optionB) => 'DOĞAL KALIN'
    };
