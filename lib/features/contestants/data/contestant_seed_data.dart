...
const contestantSeedData = <Contestant>[
  Contestant(
    ...
    producerNote:
        'Vokal, dans ve sahne hakimiyetini aynı anda taşıyabilen nadir yarışmacılardan. Beklenti yükseldikçe kendine fazla yüklenmesi en büyük riski.',
    quote:
        'Plan yapmadan rahat edemiyorum. Ama bazen planı bozmak da eğlenceli.',
    initialMotivation: 86,
  ...
  Contestant(
    ...
    occupationOrEducation: 'Mimarlık öğrencisi',
    shortBackground:
        'Eskizler ve proje teslimleri arasında geliştirdiği estetik bakışını sahneye taşıyor.',
    fullBackground:
        'Lara İstanbul’da mimarlık okuyor. Yoğun proje teslimleri, eskizler ve bitmeyen revizeler arasında yaratıcı tarafını geliştirdi. Bir fikrin yalnızca güzel görünmesinin değil, nasıl çalıştığının da önemli olduğuna inanıyor.\n\nRenk, biçim ve kompozisyonu birlikte düşünmesi sahne konseptlerini zihninde hızla canlandırmasını sağlıyor. Çevresindekilerin ihtiyaçlarını fark etme alışkanlığı prova odasında hemen hissediliyor; ancak başkalarını toparlarken kendi performansını ikinci plana atabiliyor.',
  ...
  Contestant(
    ...
    age: 22,
    city: 'Sakarya',
    occupationOrEducation: 'Profesyonel voleybolcu',
    shortBackground:
        'Maç baskısı ve yoğun antrenman temposundan geliyor; şimdi rekabetini sahneye taşıyor.',
    fullBackground:
        'Zeynep Ela Sakarya’da küçük yaşlardan beri voleybol oynuyor. Profesyonel spor hayatı ona yoğun antrenman temposunu, takım disiplinini ve seyirci baskısı altında odağını korumayı öğretti.\n\nFiziksel dayanıklılığı ve koordinasyonu güçlü; uzun provalarda temposunu kolay kaybetmiyor. Performans dünyası ise onun için daha yeni. Teknik doğruluğunu duygusal ifadeyle birleştirerek sahnede güvenilir bir takım üyesi olmak istiyor.',
    archetype: 'Saha Disiplini',
    personalityTraits: ['Rekabetçi', 'Disiplinli', 'Çalışkan', 'Dayanıklı'],
    primaryRole: 'Performansçı',
    secondaryRoles: ['Dans', 'Takım Lideri'],
    vocal: 72,
    dance: 81,
    stage: 83,
    popularity: 60,
    potential: 86,
    specialTraitTitle: 'Maç Kondisyonu',
    specialTraitDescription:
        'Baskı altında kolay dağılmaz; uzun provalarda çalışma temposunu ve takım disiplinini korur.',
    riskTitle: 'Fazla Hesaplı',
    riskDescription:
        'Kontrollü ve sonuç odaklı tavrı sahnede duygusal ifadesini zaman zaman zayıflatabilir.',
    producerNote:
        'Dayanıklılığı ve iş disiplini çok güçlü. Vokalini ve duygusal ifadesini geliştirirse final grubunun en güvenilir üyelerinden biri olabilir.',
    quote: 'Maçın son sayısında da prova sonunda da odağımı kaybetmem.',
    initialMotivation: 92,
    portraitAsset: 'assets/contestants/zeynep_ela/neutral.png',
  ),
  Contestant(
    id: 14,
    number: '14',
